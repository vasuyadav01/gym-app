...
export default function RoutineCard({ name, exercises }: RoutineCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4">
      ...
      <Link
        href="/workout/new"
        className="block w-full bg-slate-900 text-[var(--app-text)] text-sm font-medium py-2.5 rounded-xl text-center hover:bg-blue-500 active:scale-[0.98] transition-all"
      >
        Start Routine
      </Link>
    </div>
