...
export default function LoginPage() {
      ...
      <div className="min-h-screen relative overflow-hidden flex flex-col">
        ...
        <div className="relative z-10 flex flex-col min-h-screen">
          ...
          <div className="px-6 pb-8">
            <h1 className="text-white font-black uppercase leading-none tracking-tight" style={{ fontSize: "clamp(2.5rem,11vw,3.5rem)" }}>
              BE HEALTHY<br />
              BE STRONGER<br />
              BE YOURSELF
            </h1>
          ...
          <div className="px-6 pb-14 flex gap-3">
            ...
            <button
              ...
              className="flex-1 py-4 rounded-full text-white text-base font-semibold active:scale-[0.98] transition-all"
  ...
  if (view === "signup") {
    return (
      <div className="min-h-screen bg-[#131314] flex flex-col text-white">
        <div className="px-6 pt-14 pb-2">
          <button onClick={() => setView("landing")}
            className="w-9 h-9 rounded-full bg-[#1c1b1c] border border-white/10 flex items-center justify-center">
        ...
        <div className="flex-1 px-6 flex flex-col gap-4">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center px-5 py-4 rounded-2xl border border-white/10 bg-[#1c1b1c] hover:bg-[#252528] active:scale-[0.98] transition-all"
          >
            ...
            <span className="flex-1 text-center text-white text-sm font-semibold">Sign up with Google</span>
          </button>

          <div className="flex items-center gap-3">
            <div className="flex-1 h-px bg-white/10" />
            <span className="text-neutral-500 text-xs">or sign up with email</span>
            <div className="flex-1 h-px bg-white/10" />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="w-full px-4 py-4 rounded-2xl border border-white/10 bg-[#1c1b1c] text-white placeholder:text-neutral-600 text-base outline-none transition-all"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-4 pr-12 rounded-2xl border border-white/10 bg-[#1c1b1c] text-white placeholder:text-neutral-600 text-base outline-none transition-all"
                onFocus={(e) => e.currentTarget.style.borderColor = "#d9ee4f50"}
                onBlur={(e) => e.currentTarget.style.borderColor = "rgba(255,255,255,0.1)"}
              />
  ...
  return (
    <div className="min-h-screen bg-[#131314] flex flex-col text-white">
      ...
      <div className="px-6 pt-8 pb-8">
        ...
        <p className="mt-2 text-neutral-500 text-sm">Welcome back. Let&apos;s get moving.</p>
      </div>
      ...
      <div className="flex-1 px-6 flex flex-col gap-4">
        ...
        <div className="flex items-center gap-3 mt-2">
          <button
            onClick={handleGoogle}
            disabled={loading}
            className="flex-1 flex items-center justify-center h-14 rounded-2xl border border-white/10 bg-[#1c1b1c] hover:bg-[#252528] active:scale-95 transition-all"
          >
        ...
        {resetSent && (
          <div className="rounded-2xl px-4 py-3 text-center border" style={{ background: "rgba(217,238,79,0.05)", borderColor: "rgba(217,238,79,0.2)" }}>
            ...
            <p className="text-neutral-500 text-xs mt-0.5">Check your inbox and follow the link to set a new password.</p>
          </div>
        )}
      </div>
